...
Skill: [`skills/pptx/SKILL.md`](skills/pptx/SKILL.md) + [`skills/pptx/pptxgenjs.md`](skills/pptx/pptxgenjs.md) · Agent: `.claude/agents/slide-agent.md` · Tokens: `DESIGN.md` + `src/index.css`.
