...
- Delegate to **`carousel-copy-agent`** (`.cursor/agents/carousel-copy-agent.md`) with the full approved brief
- Present the JSON content brief and wait for a second approval
- Delegate to **`carousel-design-agent`** (`.cursor/agents/carousel-design-agent.md`) to build the JSX
- Delegate to **`carousel-qc-agent`** (`.cursor/agents/carousel-qc-agent.md`) to verify it
