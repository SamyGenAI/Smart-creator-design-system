...
Once you have both answers, run the infographics-designer skill workflow with the Claude agents:
- Use `.claude/agents/copy-agent.md` to write the content brief
- Present the brief and wait for my approval
- Then use `.claude/agents/design-agent.md` to build the JSX
- Then use `.claude/agents/qc-agent.md` to verify it
