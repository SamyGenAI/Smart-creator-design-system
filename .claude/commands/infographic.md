...
Delegate the entire flow to the **`infographic-design-agent`** subagent (`.claude/agents/infographic-design-agent.md`). It is the single owner of the infographic workflow — it drafts the visual brief, waits for the user to approve, and then writes the JSX.
