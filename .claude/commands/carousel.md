...
Once you have both answers, run the carousel-designer workflow with the Claude agents:
- Use `.claude/agents/carousel-copy-agent.md` to write the content brief
- Present the brief and wait for my approval
- Then use `.claude/agents/carousel-design-agent.md` to build the JSX
- Then use `.claude/agents/carousel-qc-agent.md` to verify it
